...
public class PointCloudRenderer {
  ...
  // Shader names.
  private static final String VERTEX_SHADER_NAME = "Shader/point_cloud.vert";
  private static final String FRAGMENT_SHADER_NAME = "Shader/point_cloud.frag";
  ...
  // was not changed.
  private float[] lastPointCloud = null;
...
//    ShaderUtil.checkGLError(TAG, "before create");
  ...
  public void update(float[] points) {
    ...
    numPoints = points.length / FLOATS_PER_POINT;
    ...
    GLES20.glBufferSubData(
        GLES20.GL_ARRAY_BUFFER, 0, numPoints * BYTES_PER_POINT, floatArrayToBuffer(points));
    GLES20.glBindBuffer(GLES20.GL_ARRAY_BUFFER, 0);

    ShaderUtil.checkGLError(TAG, "after update");
  }
  @NonNull
  private FloatBuffer floatArrayToBuffer(float[] vertices) {
